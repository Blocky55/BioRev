...
export const topics: Topic[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "dna-q15", question: "How many hydrogen bonds hold an A-T base pair?", options: ["1", "2", "3", "4"], correctIndex: 1 },
      { id: "dna-q16", question: "A karyotype is used to:", options: ["Measure gene expression", "Detect chromosomal abnormalities", "Sequence DNA", "Identify RNA splicing"], correctIndex: 1 },
      { id: "dna-q17", question: "Where does transcription occur?", options: ["Ribosomes", "Cytoplasm", "Nucleus", "Golgi apparatus"], correctIndex: 2 },
      { id: "dna-q18", question: "In RNA, thymine is replaced by:", options: ["Cytosine", "Guanine", "Adenine", "Uracil"], correctIndex: 3 },
      { id: "dna-q19", question: "What is the genotype?", options: ["Observable characteristics", "The combination of alleles", "The protein product", "Environmental influence on traits"], correctIndex: 1 },
      { id: "dna-q20", question: "Siamese cat coat colour is determined by:", options: ["Diet", "Temperature-sensitive tyrosinase", "UV exposure", "Random mutation"], correctIndex: 1 },
      { id: "dna-q21", question: "Identical (monozygotic) twins share what percentage of DNA?", options: ["50%", "75%", "99.9%", "100%"], correctIndex: 3 },
      { id: "dna-q22", question: "Down syndrome is caused by:", options: ["Monosomy 21", "Trisomy 21", "XXY karyotype", "Deletion on chromosome 5"], correctIndex: 1 },
      { id: "dna-q23", question: "Klinefelter syndrome has which karyotype?", options: ["XO", "XXX", "XXY", "XYY"], correctIndex: 2 },
      { id: "dna-q24", question: "The most common Cystic Fibrosis mutation is:", options: ["BRCA1", "ΔF508", "CCR5-Δ32", "V600E"], correctIndex: 1 },
      { id: "dna-q25", question: "Trinucleotide repeat expansion in Huntington's disease involves repeats of:", options: ["CGG", "CAG", "GAA", "CTG"], correctIndex: 1 },
      { id: "dna-q26", question: "Genetic anticipation means:", options: ["Symptoms appear earlier in life", "Severity increases across generations", "Mutations skip generations", "Genes activate before birth"], correctIndex: 1 },
      { id: "dna-q27", question: "The Human Genome Project sequenced DNA from how many individuals?", options: ["1", "3", "5", "10"], correctIndex: 2 },
      { id: "dna-q28", question: "How long did the Human Genome Project take?", options: ["5 years", "10 years", "13 years", "20 years"], correctIndex: 2 },
      { id: "dna-q29", question: "Pharmacogenomics studies how:", options: ["Drugs are manufactured", "Patient genomes affect drug response", "Bacteria develop resistance", "Vaccines are developed"], correctIndex: 1 },
      { id: "dna-q30", question: "Which company offers whole genome sequencing with full clinical advice?", options: ["23andMe", "AncestryDNA", "Illumina Clinical Laboratory", "MyHeritage"], correctIndex: 2 },
      { id: "dna-q31", question: "Flamingo pink colouration depends on:", options: ["Genetic mutation", "Dietary carotene", "Temperature", "UV exposure"], correctIndex: 1 },
      { id: "dna-q32", question: "Cri du chat syndrome is caused by:", options: ["Trisomy 13", "Deletion on chromosome 5", "XXY karyotype", "Trinucleotide repeat"], correctIndex: 1 }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "stem-q13", question: "Cleavage divides the zygote into:", options: ["Germ layers", "Blastomeres", "Somites", "Stem cells"], correctIndex: 1 },
      { id: "stem-q14", question: "The blastocyst forms at approximately day:", options: ["1", "3", "5", "14"], correctIndex: 2 },
      { id: "stem-q15", question: "The primitive streak defines which body axis?", options: ["Dorsal-ventral", "Left-right", "Anterior-posterior", "Proximal-distal"], correctIndex: 2 },
      { id: "stem-q16", question: "Somites develop into:", options: ["Blood cells and immune cells", "Muscles, vertebral column, and dermis", "Neurons and glia", "Digestive organs"], correctIndex: 1 },
      { id: "stem-q17", question: "What percentage of a cell's expressed genes are developmental?", options: ["1%", "5%", "10%", "20%"], correctIndex: 2 },
      { id: "stem-q18", question: "ESCs are derived from:", options: ["Adult bone marrow", "The inner cell mass", "Umbilical cord blood", "Fat tissue"], correctIndex: 1 },
      { id: "stem-q19", question: "The main ethical concern with ESCs is:", options: ["High cost", "Embryo destruction", "Cancer risk", "Low efficiency"], correctIndex: 1 },
      { id: "stem-q20", question: "Haematopoietic stem cells (HSCs) produce:", options: ["Bone and cartilage", "Blood cells", "Neurons", "Skin cells"], correctIndex: 1 },
      { id: "stem-q21", question: "MSCs can be sourced from all EXCEPT:", options: ["Bone marrow", "Fat tissue", "Umbilical cord", "Red blood cells"], correctIndex: 3 },
      { id: "stem-q22", question: "iPSCs were first created in:", options: ["1997", "2003", "2007", "2012"], correctIndex: 2 },
      { id: "stem-q23", question: "An autologous transplant uses:", options: ["Donor cells from a relative", "The patient's own cells", "Animal cells", "Synthetic materials"], correctIndex: 1 },
      { id: "stem-q24", question: "How many highly polymorphic genes encode cell surface proteins?", options: ["2", "3", "5", "10"], correctIndex: 2 },
      { id: "stem-q25", question: "Oligopotent cells can:", options: ["Become any cell type", "Form a whole organism", "Differentiate into a few related cell types", "Only produce one cell type"], correctIndex: 2 },
      { id: "stem-q26", question: "The eye is a good target for ESC therapy because it is:", options: ["Easy to access surgically", "Immunologically privileged", "The largest organ", "Rapidly regenerating"], correctIndex: 1 },
      { id: "stem-q27", question: "Telomerase is found in:", options: ["All adult cells", "Stem cells and cancer cells", "Red blood cells only", "Neurons only"], correctIndex: 1 },
      { id: "stem-q28", question: "The first tracheal engineering with a patient's own stem cells was in:", options: ["2001", "2005", "2008", "2012"], correctIndex: 2 },
      { id: "stem-q29", question: "Unproven stem cell clinics are a concern because:", options: ["They use ESCs", "They lack published trial data", "They are too expensive", "They only treat cancer"], correctIndex: 1 },
      { id: "stem-q30", question: "Totipotent cells exist from the zygote to approximately the:", options: ["2-cell stage", "8-cell stage", "Blastocyst stage", "Gastrulation stage"], correctIndex: 1 }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "pm-q13", question: "Garrod identified the inheritance of alkaptonuria in:", options: ["1865", "1902", "1953", "1977"], correctIndex: 1 },
      { id: "pm-q14", question: "G6PD deficiency causes toxicity to which antimalarial drug?", options: ["Chloroquine", "Primaquine", "Artemisinin", "Quinine"], correctIndex: 1 },
      { id: "pm-q15", question: "Traditional medicine is criticised as:", options: ["Too expensive", "One size fits all", "Too personalised", "Genetically targeted"], correctIndex: 1 },
      { id: "pm-q16", question: "BRCA-positive women have a lifetime ovarian cancer risk of approximately:", options: ["13%", "30%", "60%", "85%"], correctIndex: 2 },
      { id: "pm-q17", question: "IHC testing for HER2 measures:", options: ["Gene amplification", "Protein level", "RNA expression", "Methylation status"], correctIndex: 1 },
      { id: "pm-q18", question: "FISH testing determines:", options: ["Protein folding", "Gene amplification", "Drug metabolism rate", "Immune response"], correctIndex: 1 },
      { id: "pm-q19", question: "EGFR inhibitors in lung cancer target which mutations?", options: ["BRCA1 and BRCA2", "Exon 19 deletion and L858R", "V600E and V600K", "TP53 and RB1"], correctIndex: 1 },
      { id: "pm-q20", question: "When Ki67 levels decrease during treatment, it indicates:", options: ["Drug resistance", "Treatment is working", "Cancer is spreading", "Immune suppression"], correctIndex: 1 },
      { id: "pm-q21", question: "How many drug-biomarker pairs currently exist?", options: ["50", "150", "261", "362"], correctIndex: 3 },
      { id: "pm-q22", question: "Spritam is an example of:", options: ["Gene therapy", "3D-printed medication", "Immunotherapy", "Companion diagnostic"], correctIndex: 1 },
      { id: "pm-q23", question: "Dr Lukus Wartman's cancer was treated by:", options: ["Standard chemotherapy", "Sequencing his cancer genome and targeting overactive genes", "Bone marrow transplant alone", "Experimental vaccine"], correctIndex: 1 },
      { id: "pm-q24", question: "The 'Participatory' in P4 medicine means:", options: ["Patients participate in clinical trials", "Patients are active partners in their care", "Doctors participate in research", "Pharmacists participate in prescribing"], correctIndex: 1 },
      { id: "pm-q25", question: "Driver mutations in cancer:", options: ["Are harmless passengers", "Actively promote cancer growth", "Only occur in benign tumours", "Are always inherited"], correctIndex: 1 },
      { id: "pm-q26", question: "CYP2C19 poor metabolisers taking Clopidogrel have how much higher clot risk?", options: ["No increase", "2-fold", "3-fold", "5-fold"], correctIndex: 2 },
      { id: "pm-q27", question: "Proteomics is the study of:", options: ["All genes in a genome", "All proteins in a cell or tissue", "Lipid metabolism", "Drug interactions"], correctIndex: 1 },
      { id: "pm-q28", question: "Ottenberg's 1907 contribution to precision medicine was:", options: ["Discovering DNA structure", "First blood transfusion with compatibility testing", "Identifying CYP450 enzymes", "Completing the Human Genome Project"], correctIndex: 1 },
      { id: "pm-q29", question: "Precision medicine in infectious disease uses genomic sequencing to:", options: ["Create new antibiotics", "Map transmission chains and identify resistance", "Replace vaccination", "Eliminate all bacteria"], correctIndex: 1 },
      { id: "pm-q30", question: "Oncotype DX costs approximately:", options: ["$500", "$1,500", "$4,175", "$10,000"], correctIndex: 2 }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "brain-q13", question: "Gyri are:", options: ["Valleys on the brain surface", "Ridges on the brain surface", "Fluid-filled cavities", "White matter tracts"], correctIndex: 1 },
      { id: "brain-q14", question: "The cerebellum coordinates:", options: ["Language processing", "Movement and posture", "Emotional regulation", "Visual processing"], correctIndex: 1 },
      { id: "brain-q15", question: "The brainstem contains centres for:", options: ["Personality and planning", "Cardiovascular and respiratory control", "Learning and memory", "Vision and hearing"], correctIndex: 1 },
      { id: "brain-q16", question: "The CNS consists of:", options: ["Spinal nerves and cranial nerves", "Brain and spinal cord", "Sympathetic and parasympathetic divisions", "Motor and sensory neurons only"], correctIndex: 1 },
      { id: "brain-q17", question: "Schwann cells myelinate neurons in the:", options: ["CNS only", "PNS only", "Both CNS and PNS", "Brain only"], correctIndex: 1 },
      { id: "brain-q18", question: "Astrocytes contribute to the:", options: ["Immune response via phagocytosis", "Blood-brain barrier", "Myelination of CNS axons", "Production of cerebrospinal fluid"], correctIndex: 1 },
      { id: "brain-q19", question: "During depolarisation, which ion floods into the cell?", options: ["Potassium (K+)", "Sodium (Na+)", "Calcium (Ca2+)", "Chloride (Cl-)"], correctIndex: 1 },
      { id: "brain-q20", question: "Serotonin is primarily associated with:", options: ["Reward and motivation", "Mood and sleep", "Alertness and fight-or-flight", "Excitation and learning"], correctIndex: 1 },
      { id: "brain-q21", question: "GABA's main function in the brain is:", options: ["Excitation", "Inhibition", "Myelination", "Neurogenesis"], correctIndex: 1 },
      { id: "brain-q22", question: "GxE in the context of disease means:", options: ["Gene expression", "Gene-environment interaction", "Genetic extinction", "Genome expansion"], correctIndex: 1 },
      { id: "brain-q23", question: "MIA stands for:", options: ["Multiple Immune Antibodies", "Maternal Immune Activation", "Myelin Inhibitor Agent", "Motor Interneuron Activity"], correctIndex: 1 },
      { id: "brain-q24", question: "The Dutch Hunger Winter occurred in:", options: ["1918-19", "1939-40", "1944-45", "1957-58"], correctIndex: 2 },
      { id: "brain-q25", question: "Cytokines in normal brain development guide:", options: ["Blood vessel formation", "Neuron migration", "Bone growth", "Hormone secretion"], correctIndex: 1 },
      { id: "brain-q26", question: "GWAS supports which genes as schizophrenia risk factors?", options: ["Haemoglobin genes", "Myelin-related genes", "Insulin receptor genes", "Collagen genes"], correctIndex: 1 },
      { id: "brain-q27", question: "The Na+/K+ pump moves:", options: ["3 Na+ in, 2 K+ out", "3 Na+ out, 2 K+ in", "Equal Na+ and K+ in both directions", "Only K+ out of the cell"], correctIndex: 1 },
      { id: "brain-q28", question: "Glutamate's primary role is:", options: ["Inhibition", "Excitation and learning", "Hormone regulation", "Immune response"], correctIndex: 1 },
      { id: "brain-q29", question: "Noradrenaline is associated with:", options: ["Calming and relaxation", "Alertness and fight-or-flight", "Digestion", "Sleep induction"], correctIndex: 1 },
      { id: "brain-q30", question: "The frontal lobe is responsible for:", options: ["Vision", "Hearing", "Movement, personality, and planning", "Sensory processing"], correctIndex: 2 }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "micro-q13", question: "Viruses operate at which scale?", options: ["Millimetre", "Micrometre", "Nanometre", "Picometre"], correctIndex: 2 },
      { id: "micro-q14", question: "H. pylori was found to cause:", options: ["Pneumonia", "Stomach ulcers", "Tuberculosis", "Meningitis"], correctIndex: 1 },
      { id: "micro-q15", question: "HPV is linked to:", options: ["Lung cancer", "Cervical cancer", "Leukaemia", "Skin melanoma"], correctIndex: 1 },
      { id: "micro-q16", question: "Beta-lactamases destroy antibiotics by breaking:", options: ["Peptide bonds", "The beta-lactam ring", "DNA strands", "Cell membranes"], correctIndex: 1 },
      { id: "micro-q17", question: "Which resistance mechanism is considered innate?", options: ["Efflux pumps", "Target modification", "Impermeability", "Drug inactivation"], correctIndex: 2 },
      { id: "micro-q18", question: "Target bypass resistance works by:", options: ["Destroying the drug", "Evolving alternative metabolic pathways", "Pumping the drug out", "Hiding the target"], correctIndex: 1 },
      { id: "micro-q19", question: "Resistance genes are often transferred via:", options: ["Mitosis", "Meiosis", "Plasmid DNA (horizontal gene transfer)", "Vertical inheritance only"], correctIndex: 2 },
      { id: "micro-q20", question: "Lytic phages:", options: ["Enter dormancy in the host", "Kill bacteria directly", "Only infect eukaryotic cells", "Cause antibiotic resistance"], correctIndex: 1 },
      { id: "micro-q21", question: "Bacteriophages were first discovered in:", options: ["1895 and 1901", "1915 and 1917", "1928 and 1932", "1945 and 1950"], correctIndex: 1 },
      { id: "micro-q22", question: "The FDA licensed phages for food processing against:", options: ["Salmonella", "E. coli", "Listeria", "Campylobacter"], correctIndex: 2 },
      { id: "micro-q23", question: "MRSA peak UK blood infections per year were approximately:", options: ["700", "2,000", "7,000", "20,000"], correctIndex: 2 },
      { id: "micro-q24", question: "PBP2a in MRSA stands for:", options: ["Plasmid-Binding Protein 2a", "Penicillin-Binding Protein 2a", "Peptide-Based Polymer 2a", "Phage-Binding Protein 2a"], correctIndex: 1 },
      { id: "micro-q25", question: "C. difficile peak cases in the UK in 2007 were:", options: ["5,500", "18,970", "55,498", "100,000"], correctIndex: 2 },
      { id: "micro-q26", question: "CPE stands for:", options: ["Cell-Penetrating Enzymes", "Carbapenemase-Producing Enterobacteriaceae", "Capsule-Protected Endospores", "Conjugation-Prone E. coli"], correctIndex: 1 },
      { id: "micro-q27", question: "The human gut contains approximately how many microorganisms?", options: ["1 billion", "10 billion", "1 trillion", "100 trillion"], correctIndex: 3 },
      { id: "micro-q28", question: "Chlamydia trachomatis is a:", options: ["Virus", "Gram-positive cocci", "Gram-negative obligate intracellular bacterium", "Fungal pathogen"], correctIndex: 2 },
      { id: "micro-q29", question: "Syphilis (Treponema pallidum) is classified as a:", options: ["Gram-positive coccus", "Spirochaete", "Gram-negative rod", "Acid-fast bacillus"], correctIndex: 1 },
      { id: "micro-q30", question: "Syphilis diagnoses in England in 2023 were the highest since:", options: ["1918", "1948", "1978", "2000"], correctIndex: 1 }
    ]
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    quiz: [
      ...
      { id: "cons-q13", question: "Simpson's Index measures the probability that:", options: ["A species will go extinct", "Two random individuals are different species", "A habitat is protected", "A population is inbreeding"], correctIndex: 1 },
      { id: "cons-q14", question: "Shannon Index accounts for:", options: ["Richness only", "Evenness only", "Both richness and evenness", "Genetic diversity only"], correctIndex: 2 },
      { id: "cons-q15", question: "How many conservation hotspots exist worldwide?", options: ["12", "24", "36", "50"], correctIndex: 2 },
      { id: "cons-q16", question: "Conservation hotspots support what percentage of endemic plant species?", options: [">10%", ">25%", ">50%", ">75%"], correctIndex: 2 },
      { id: "cons-q17", question: "The Almendro tree is important because:", options: ["It produces medicine", "88% of Great Green Macaw nests are in it", "It is the tallest tropical tree", "It filters water"], correctIndex: 1 },
      { id: "cons-q18", question: "An umbrella species' conservation value is tied to its:", options: ["Population size", "Geographic range", "Body mass", "Reproductive rate"], correctIndex: 1 },
      { id: "cons-q19", question: "A naturalised species is:", options: ["A native species", "An alien species that has established itself", "An endangered species", "A keystone species"], correctIndex: 1 },
      { id: "cons-q20", question: "Signal crayfish transmit:", options: ["Squirrelpox", "Crayfish plague", "Chytrid fungus", "Avian flu"], correctIndex: 1 },
      { id: "cons-q21", question: "American mink caused what percentage decline in UK water voles?", options: ["25%", "50%", "75%", "95%"], correctIndex: 3 },
      { id: "cons-q22", question: "Feral cats are responsible for approximately how many mammal extinctions in Australia?", options: ["5", "10", "20", "50"], correctIndex: 2 },
      { id: "cons-q23", question: "Himalayan balsam spreads via:", options: ["Wind dispersal", "Bird transport", "Explosive seedpods", "Underground runners"], correctIndex: 2 },
      { id: "cons-q24", question: "R-strategist invasive species are characterised by:", options: ["Long generation times, few offspring", "Short generation times, many offspring", "Specialist niche requirements", "Low dispersal ability"], correctIndex: 1 },
      { id: "cons-q25", question: "Propagule pressure refers to:", options: ["Environmental disturbance", "Being introduced in large numbers or often", "Predator-prey relationships", "Soil nutrient levels"], correctIndex: 1 },
      { id: "cons-q26", question: "CITES regulates:", options: ["Carbon emissions", "Trade in endangered species", "Fishing quotas", "Deforestation rates"], correctIndex: 1 },
      { id: "cons-q27", question: "NNSS stands for:", options: ["National Nature Safety Service", "Non-native Species Secretariat", "Natural Neighbourhood Sustainability Scheme", "Northern Nature Survey Station"], correctIndex: 1 },
      { id: "cons-q28", question: "The chytrid fungal diseases threatening amphibians are:", options: ["Bd and Bsal", "HIV and HPV", "MRSA and CPE", "TB and XDR-TB"], correctIndex: 0 },
      { id: "cons-q29", question: "Rabbits cause approximately how much in UK crop losses per year?", options: ["£10m", "£50m", "£170m", "£500m"], correctIndex: 2 },
      { id: "cons-q30", question: "Species richness measures:", options: ["Genetic variation within species", "Number of species in an area", "Relative abundance of species", "Habitat diversity"], correctIndex: 1 }
    ]
  }
];
